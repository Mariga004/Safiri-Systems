...
export default function BusesPage() {
  ...
  const displayedBuses = filteredBuses.slice(0, entriesPerPage);
    ...
    <div className="max-w-6xl mx-auto">
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        ...
        <div className="flex flex-col md:flex-row justify-between gap-4 mb-4">
          {/* Show entries dropdown - MORE VISIBLE */}
          ...
          {/* Search - REDUCED WIDTH + VISIBLE TEXT */}
          <div className="flex items-center gap-2">
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-xs md:text-sm">
            {/* DEEP AMBER HEADERS WITH VISIBLE TEXT */}
        ...
        <div className="mt-4 text-sm font-medium text-gray-900">
          Showing {displayedBuses.length} of {filteredBuses.length} buses
        </div>
      </div>
    </div>
  );
